...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: '/services/pc-build', element: <PcBuildPage /> },
      { path: '/services/repair', element: <RepairPage /> },
      { path: '/services/repair/pc', element: <RepairPcPage /> },
      { path: '/services/repair/laptop', element: <RepairLaptopPage /> },
      { path: '/services/repair/phone', element: <RepairPhonePage /> },
      { path: '/software/chatbot', element: <ChatbotsPage /> },
      { path: '/software/app', element: <SoftwareAppPage /> },
      { path: '/software/site', element: <SoftwareSitePage /> },
